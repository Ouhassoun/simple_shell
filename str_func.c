...
/**
 * jag_puts - writes a string to standard output
 * @str: string to write
 *
...
/**
 * jag_strdup - returns pointer to new mem alloc space which contains copy
...
/**
 * jag_strcmpr - compares two strings
...
/**
 * jag_strcat - concatenates two strings
 * @strc1: first string
 * @strc2: second string
 * Return: pointer
 */
...
/**
 * jag_strlen - returns the length of a string
