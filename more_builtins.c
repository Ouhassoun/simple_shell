...
/**
 * jag_add_key - create a new environment variable
...
/**
 * jag_find_key - finds an environment variable
...
/**
 * jag_add_value - create a new environment variable string
 * @key: variable name
...
/**
 * jag_atoi - converts a string into an integer
